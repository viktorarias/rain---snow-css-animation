...
for (var i = 0; i < numberOfDrops; i++) {
  var createDrop = document.createElement('DIV');
...
timeLine.addLabel('frame1').to(drop, 0, {
  css: {
    className: '+=rain'
  }
}, 'frame1').addLabel('frame2', '+=.2').to(drop, 0, {
  css: {
    className: '+=snow'
  }
}, 'frame2'); // .to([creative.dom.f2Snow1, creative.dom.f2Snow2,creative.dom.bgExit],0,{zIndex: 1});
...
},{"gsap/TweenMax":"../node_modules/gsap/TweenMax.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "65130" + '/');
